...
#include "LMSvgUtil.h.h"
#include "Utils.h"
#ifdef EKA2
#include "IconFileProvider.h"
#include "YCBrowserDocument.h"
#endif

_LIT(KIconBasename, "lemontangram.mbm");
...
#ifdef EKA2
	CYCBrowserDocument* document = (CYCBrowserDocument*)((CEikAppUi*)(CEikonEnv::Static()->AppUi()))->Document();
