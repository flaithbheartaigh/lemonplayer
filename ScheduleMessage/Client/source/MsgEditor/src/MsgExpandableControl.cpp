...
//
//    TAknWindowLineLayout layout1 = AknLayoutScalable_Apps::msg_text_pane( 0 );
//    TAknWindowLineLayout layout2 = AknLayoutScalable_Apps::msg_header_pane();
//    TAknTextLineLayout   layout3 = AknLayoutScalable_Apps::msg_header_pane_t1( 0 );
//    TAknTextComponentLayout layout4 = AknLayoutScalable_Apps::msg_header_pane_t1( 0 );
//    
...
//    TInt w = msgHeaderPane.Rect().Width();
//    iCaptionLayout.LayoutText( msgHeaderPane.Rect(),
//                               AknLayoutScalable_Apps::msg_header_pane_t1( 0 ).LayoutLine() );
//    iCaptionLayout.LayoutText( TRect(0,0,100,100),
//    		ELatinBold19,215,6,156,20,0,ELayoutAlignRight );
    iCaptionLayout.LayoutText( msgHeaderPane.Rect(),
    		ELatinBold19,215,6,msgHeaderPane.Rect().Width()==230?156:236,20,0,ELayoutAlignRight );
...
//                              editorLineLayout );
    iEditorLayout.LayoutText( msgHeaderPane.Rect(),
    		ELatinBold19,215,88,5,20,0,ELayoutAlignLeft );
...
//    iEditor->SetAlignment( editorLineLayout.iJ );
    iEditor->SetAlignment( ELayoutAlignLeft );
    }
