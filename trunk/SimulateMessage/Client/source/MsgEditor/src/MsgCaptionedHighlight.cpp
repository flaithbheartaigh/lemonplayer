...
//    TAknWindowLineLayout layout = AknLayoutScalable_Apps::msg_text_pane( 0 ).LayoutLine();
...
//    layout = AknLayoutScalable_Apps::msg_header_pane( 0 ).LayoutLine();
...
//    layout = AknLayoutScalable_Apps::input_focus_pane_cp07( 0 ).LayoutLine();
//    iFrame.LayoutRect(
//        msgHeaderPane.Rect(),
...
//    TAknTextLineLayout layout2 = AknLayoutScalable_Apps::msg_header_pane_t1( 0 ).LayoutLine();
//    iText.LayoutText(
//        msgHeaderPane.Rect(),
//        AknLayoutScalable_Apps::msg_header_pane_t1( 0 ).LayoutLine() );
//    iText.LayoutText(
//        msgHeaderPane.Rect(),
//        2,215,6,156,0,0,ELayoutAlignRight );
//    iText.LayoutText(
//        msgHeaderPane.Rect(),
//        -2107637758, 215, 6, 156, 16363, 0, ELayoutAlignRight);
    iText.LayoutText(
        msgHeaderPane.Rect(),
        ELatinBold19, 215, 6, 156, 20, 0, ELayoutAlignRight);

    
//    layout = AknLayoutScalable_Avkon::bg_list_pane_g4( 2 ).LayoutLine();
//    iVertBar.LayoutRect(
//        dataPane,
